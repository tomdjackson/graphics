...
void LoadTestModel( std::vector<Triangle>& triangles )
{
	...
	// Left wall
	triangles.push_back( Triangle( A, E, C, purple, Diff) );
	triangles.push_back( Triangle( C, E, G, purple, Diff) );

	// Right wall
	triangles.push_back( Triangle( F, B, D, yellow, Spec) );
	triangles.push_back( Triangle( H, F, D, yellow, Spec) );
	...
	// Front
	triangles.push_back( Triangle(E,B,A,blue, Diff) );
	triangles.push_back( Triangle(E,F,B,blue, Diff) );

	// Front
	triangles.push_back( Triangle(F,D,B,blue, Diff) );
	triangles.push_back( Triangle(F,H,D,blue, Diff) );

	// BACK
	triangles.push_back( Triangle(H,C,D,blue, Diff) );
	triangles.push_back( Triangle(H,G,C,blue, Diff) );

	// LEFT
	triangles.push_back( Triangle(G,E,C,blue, Diff) );
	triangles.push_back( Triangle(E,A,C,blue, Diff) );

	// TOP
	triangles.push_back( Triangle(G,F,E,blue, Diff) );
	triangles.push_back( Triangle(G,H,F,blue, Diff) );
